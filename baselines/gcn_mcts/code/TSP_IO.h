...
//double Param_T=0.25;  	 //used to control the termination condition
...
//	Heatmap_File_Name[len++]='/';
	...
	if(Temp_City_Num == 500) {
        ...
        int d1, d2, d3, d4;
        d1 = Temp_City_Num / 1000;
        d2 = (Temp_City_Num - d1 * 1000) / 100;
        d3 = (Temp_City_Num - d1 * 1000 - d2 * 100) / 10;
        d4 = Temp_City_Num - d1 * 1000 - d2 * 100 - d3 * 10;
        Heatmap_File_Name[len++] = '0' + d1;
        Heatmap_File_Name[len++] = '0' + d2;
        Heatmap_File_Name[len++] = '0' + d3;
        Heatmap_File_Name[len++] = '0' + d4;

//        int d1, d2, d3, d4, d5;
//        d1 = Temp_City_Num / 10000;
//        d2 = (Temp_City_Num - d1 * 10000) / 1000;
//        d3 = (Temp_City_Num - d1 * 10000 - d2 * 1000) / 100;
//        d4 = (Temp_City_Num - d1 * 10000 - d2 * 1000 - d3 * 100) / 10;
//        d5 = Temp_City_Num - d1 * 10000 - d2 * 1000 - d3 * 100 - d4 * 10;
//        //cout << "d1: " << d1 << " d2: " << d2 << " d3: " << d3 << " d4: " << d4 << " d5: " << d5 << endl;
//        Heatmap_File_Name[len++] = '0' + d1;
//        Heatmap_File_Name[len++] = '0' + d2;
//        Heatmap_File_Name[len++] = '0' + d3;
//        Heatmap_File_Name[len++] = '0' + d4;
//        Heatmap_File_Name[len++] = '0' + d5;
//        //cout << "Heatmap_File_Name: " << Heatmap_File_Name << endl;
    }
